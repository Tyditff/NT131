...
export const createVehicleValidator = validateRequestPart(
  "body",
  createVehicleSchema,
);
...
export const vehicleIdParamValidator = validateRequestPart(
  "params",
  vehicleIdParamSchema,
);

export const listVehiclesValidator = validateRequestPart(
  "query",
